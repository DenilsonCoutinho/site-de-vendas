...
import comment02 from '../../assets/testimonials/WhatsApp Image 2025-07-15 at 16.34.50 (2).jpeg'
...
const TestimonialsSection = () => {
  return (
    <section className="min-h-dvh py-20 bg-bgPrimary overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial) => (
            <Card key={testimonial.id} className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-0 overflow-hidden">
